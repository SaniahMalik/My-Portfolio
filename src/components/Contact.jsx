                        ...
                        <div className='flex items-start '>
                         ...
                         <div className='flex items-start '>
                            ...
                            <div>
                                ...
                                <p className='text-gray-400'>saniahmalik19@gmail.com</p>
                            </div>
                        </div>
                          ...
                          <div className='flex items-start '>
                            ...
                            <div>
                                ...
                                <p className='text-gray-400'>+92 3281678832</p>
                            </div>
                        </div>
                        <div className='pt-4'>
                            <h3 className='text-lg font-seminbold mb-4'>Follow Me</h3>
                            <div className='flex space-x-4'>
                                <a href="https://github.com/SaniahMalik" className='w-12 h-12 rounded-full bg-dark-300 flex items-center justify-center text-gray-200 hover:bg-gray-500 hover:text-white transition duration-300'><FaGithub /></a>

                                <a href="https://www.linkedin.com/in/saniah-malik-5850953b5/" className='w-12 h-12 rounded-full bg-dark-300 flex items-center justify-center text-blue-400 hover:bg-blue-400 hover:text-white transition duration-300'><FaLinkedin /></a>
