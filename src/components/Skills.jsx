...
import { skills } from '../assets/assets' // 1. Skills array import kar diya hai
  ...
  return (
    ...
    >
      <div className='container mx-auto px-6'>
        ...
        {/* 2. Grid Container ke andar .map() ko wrap kar diya hai */}
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8  mx-auto'>
          {skills.map((skill, index) => (
            ...
            >
              ...
              <p className='tet-gray-400 mb-4'>{skill.description}</p>
